                ...
                <section class="middle-section">
                    ...
                    <section class="third-section">
                        ...
                        <div class="appli">
                            ...
                            <p>est le sommaire digital au magazine "Society". Conçu avec <a href="https://wordpress.com/fr/">Wordpress</a>, c’est l’un des sites qui utilise le SSO pour l’authentification au back-office.</p>
                        </div>
                        <div class="appli">
                            <h3>3.2.2.3. <a class="title_link" href="https://www.allso.tv/">Allso</a>, <a class="title_link" href="https://www.sovage.tv/">Sovage</a> :</h3>
                            <p>les deux sites exposent le travail de production audiovisuelle de SOPRESS, Ils sont tous les deux conçu avec <a href="https://wordpress.com/fr/">Wordpress</a>.</p>
                        </div>
                    </section>
                </section>
                <section class="middle-section">
                    ...
                    <div class="projet">
                        ...
                        <b class="fifth-title">Travail effectué</b>
                        <ol>
                    ...
                    <div class="projet">
                        ...
                        <p>Après avoir créé l'environnement local adéquat(Vhost, téléchargement du plugin..), j'ai commencé par adapter le code de la liseuse en intégrant le plugin et en apportant les modifications de design adéquates (exemple : mettre les couleurs de la liseuse aux couleur de la maif)
                            <br /><br />J'ai ensuite livré une première version à mon tuteur en lui exposant les points pouvant être améliorés ou corrigés, exemple, le zoom qui n'était pas suffisant dans certains cas. Il a pris la relève sur le projet pour effectuer une modification qui a consisté à transformer le PDF en image qui étaient ensuite streamées.
                    ...
                    <div class="projet">
                        ...
                        <p>
                            ...
                            <b class="fifth-title">Travail effectué</b><br />
                        ...
                        <p>Suite à la demande de plusieurs employés pour avoir accès aux PDFs des magazines, on a décidé d'enrichir un outil déjà existant qui permet de télécharger les couvertures, logo, et doubles pages des magazines en y ajoutant une visionneuse de PDFS avec possibilité de téléchargement.
                            ...
                            <b class="fifth-title">Travail effectué</b><br />
                            J'ai commencé par adapter le code de la visionneuse/liseuse à nos besoins en minimisant le nombre de fonctionnalités et en utilisant le stream de PDF fourni par le plugin au lieu du stream d'images.
                    ...
                    <div class="projet">
                        ...
                        <p>
                            ...
                            <br /><br /><b class="fifth-title">Travail effectué</b><br />
